---
sidebar_label: Copy category json file to each folder with proper content
description: Copy category json file to each folder with proper content.
---

# Copy category json file to each folder with proper content

## Create empty `_category_.json` in working directory

## Create `script.sh`

Paste following code in `script.sh` file.
