---
sidebar_label: Copy category json file for guides directory
description: Copy category json file for guides directory.
---

# Copy category json file for guides directory
